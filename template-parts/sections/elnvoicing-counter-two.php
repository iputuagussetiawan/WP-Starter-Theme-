...
?>
<section class="elnvoicing-counter elnvoicing-counter2 section-padding" style="background-image:url(<?php echo  $urlOur_einvoicing_bg ?>);">
    <div class="container">
        ...
        <div class="elnvoicing-counter__grid">
            <div class="card-approach" data-aos="fade-up" data-aos-delay="100">
                <div class="card-approach__value">
                    $<h3 class="card-approach__value-title" id="worthOfInvoices2" data-value="<?= $worth_of_invoices_value; ?>"> </h3>m
                </div>
            ...
            <div class="card-approach" data-aos="fade-up" data-aos-delay="200">
                <div class="card-approach__value">
                    <h3 class="card-approach__value-title" id="Invoices2" data-value="<?= $invoices_value; ?>"> </h3>
                </div>
                <div class="card-approach__label">
                    <?= $invoices_label; ?>
                </div>
            ...
            <div class="card-approach" data-aos="fade-up" data-aos-delay="300">
                <div class="card-approach__value">
                    <h3 class="card-approach__value-title" id="suppliers2" data-value="<?= $suppliers_value; ?>"> </h3>
                </div>
                <div class="card-approach__label">
                    <?= $suppliers_label; ?>
                </div>
            ...
            <div class="card-approach" data-aos="fade-up" data-aos-delay="400">
                <div class="card-approach__value">
                    $<h3 class="card-approach__value-title" id="ofPeppolEInvoices2" data-value="<?= $of_peppol_eInvoices_value; ?>"> </h3>K
                </div>
                <div class="card-approach__label">
