    ...
    <div class="container">
        ...
        ?>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo site_url(); ?>"> <?php echo pll__('Home Text'); ?></a></li>
                    <?php
                    if (is_singular('post')) :
                    ?>
...
<footer class="footer section-padding--top">
    <div class="container">
        <div class="card-booking">
            <div class="card-booking__info-container">
                <picture>
                    <source media="(min-width:768px)" srcset="<?php echo get_template_directory_uri() . '/src/images/vector/card-booking/Desktop/Banner_Ornamnet_Desktop.svg' ?>">
                    <img class="card-booking__ornamet" src="<?php echo get_template_directory_uri() . '/src/images/vector/card-booking/Mobile/Banner_Ornamnet_Mobile.svg' ?>" alt="Banner Ornamnet Desktop.svg">
                </picture>
                <h3 class="card-booking__title">
                    <?php echo pll__('Book In A Consultation With Our Experts'); ?>
                </h3>
                <a href="<?= $contactLink; ?>" class="btn btn-primary"><?php echo pll__('Speak To An Expert'); ?></a>
            </div>
            <div class="card-booking__image-container">
                <picture>
                    <source media="(min-width:768px)" srcset="<?php echo $urlFooterBookingImage; ?>">
                    <img src="<?php echo $urlFooterBookingImageMobile; ?>" alt="<?php echo pll__('Speak To An Expert'); ?>">
                </picture>
            </div>
        </div>
        <div class="footer__grid section-padding--top">
            <div class="footer__infos-container">
                <a href="<?php echo site_url(); ?>" class="footer__logo-container" aria-label="Valtatech Logo">
                    <img src="<?php echo $urlFooterLogo; ?>" class="footer__logo" alt="<?php echo $altFooterLogo; ?>">
                </a>
                    ...
                    ?>
                            ...
                            ?>
                                <div class="footer__certification-image-container">
                                    <img class="footer__certification-image img-fluid" src="<?php echo esc_url($certificationImage['url']); ?>" alt="<?php echo  $certificationTitle ?>">
                                </div>
                            <?php
                            endif;
                            ?>
            ...
            <div class="footer__copyright">
                <p class="footer__copyright-text">© <?php echo date('Y') ?> Valtatech.<?php echo pll__('All Rights Reserved. Powered by'); ?> <?php echo $copyrightUrl; ?></p>
